...
I chose to try designing the Logic Gates component here because I thought it was
the most interesting out of my three original ideas. I am much more worried about its difficulty of implementation than I would be for the other two, and I'm not totally sure I'll actually go through with it until the end, but I think designing and prototyping it for now will be a good learning experience. I expect to make heavy changes. In the end, the largest factor of what I choose to go with will probably be the time commitment. I do think it would be manageable, but I've noticed I've been much, much more busy this semester than the last. Ultimately though, I just thought the logic gates would be more interesting for now. It also kind of ties in to my foundations course.
